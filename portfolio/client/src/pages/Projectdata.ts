...
export const deslist: destype[] = [
    ...
    },
    {
        ...
        content: [
            {
                "스페셜오퍼 상품 필터링 기능 구현": [
                    "다중 필터링 조건을 활용해서 사용자 검색 편의성 최적화",
                ],
            },
            {
                "반응형 레이아웃으로 이벤트 페이지 작업": [
                    "다양한 디바이스에 최적화된 반응형 레이아웃 적용",
                ],
            },
            {
                "공지사항 제목 및 내용 검색 기능 추가": [
                    "공지사항의 제목과 내용을 기준으로 검색할 수 있는 기능 개발",
                ],
            },
            {
                "아이디 및 비밀번호 찾기 기능 구현": [
                    "사용자가 계정 정보를 쉽게 복구할 수 있도록 아이디/비밀번호 찾기  프로세스 구현",
                ],
            },
            {
                "관리자 공지사항 관리 시스템 구축": [
            ...
            {
                "게시판 파일 업로드 및 출력 기능 구현": [
                    "글 등록시 파일 업로드 및 출력 기능 추가",
                ],
            },
            {
                "게시판 조회수 시스템 구현": [
                    "게시글 상세페이지 접근 시 조회수 자동 증가 기능",
                ],
            },
        ],
    },
